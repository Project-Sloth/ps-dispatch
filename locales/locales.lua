Locales = {
    ...
    ['es'] = {
        ...
        ['coupe'] = "Coupe",
        ['muscle'] = "Muscle car",
        ['sports_classic'] = "Clasico Deportivo",
        ['sports'] = "Carro Deportivo",
        ['super'] = "Super carro",
        ['motorcycle'] = "Motocicleta",
        ['offroad'] = "Todo-terreno",
        ['industrial'] = "Vehiculo Industrial",
        ...
        ['truck'] = "Truck",
        -- DISPATCH MESSAGES
        ['vehicleshots'] = "Disparos desde un Vehiculos",
        ['shooting'] = "Alerta de Disparos",
        ['melee'] = "Pelea en progreso",
        ['driveby'] = "Disparos desde un Vehiculo",
        ['speeding'] = "Conduccion Temeraria",
        ['autotheft'] = "Robo de Auto",
        ['persondown'] = "Persona Herida",
        ['storerobbery'] = "Robo a Tienda",
        ['fleecabank'] = "Robo Banco Fleeca",
        ['paletobank'] = "Robo Banco Paleto",
        ['pacificbank'] = "Robo Banco Pacifico",
        ['prisonbreak'] = "Fuga de Carcel en Progeso",
        ['vangelico'] = "Robo a Joyeria Vangelico",
        ['houserobbery'] = "Alarma de Casa Activada",
        ['drugsell'] = "Actividad Sospechosa",
        ['carjacking'] = "Car Jacking", 
        ['vehicletheft'] = "Robo de Vehiculo", 
        ['officerdown'] = "Oficial Herido",
        ['emsdown'] = "EMS Herido",
        ['artgalleryrobbery'] = "Robo de Galeria de Arte",
        ['humanerobbery'] = "Robo de Humane Labs",
        ['trainrobbery'] = "Robo en el Tren",
        ['vanrobbery'] = "Robo de Camion Blindado",
        ['underground'] = "Robo de Bunker",
        ['drugboatrobbery'] = "Bote Sospechoso",
        ['unionrobbery'] = "Robo a Banco Central",
        ['carboosting'] = "Car Boost en Proceso",
        ['yachtheist'] = "Alerta en el Yate",
    }
}

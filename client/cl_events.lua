...
local function Shooting()
    ...
    if CurrentWeapon == 584646201 then weapon = "CLASS 2: AP Pistol" elseif CurrentWeapon == 453432689 then weapon = "CLASS 1: Pistol" elseif CurrentWeapon == 3219281620 then weapon = "CLASS 1: Pistol MK2" elseif CurrentWeapon == 1593441988 then weapon = "CLASS 1: Combat Pistol" elseif CurrentWeapon == -1716589765 then weapon = "CLASS 1: Heavy Pistol" elseif CurrentWeapon == -1076751822 then weapon = "CLASS 1: SNS Pistol" elseif CurrentWeapon == -771403250 then weapon = "CLASS 2: Desert Eagle" elseif CurrentWeapon == 137902532 then weapon = "CLASS 2: Vintage Pistol" elseif CurrentWeapon == -598887786 then weapon = "CLASS 2: Marksman Pistol" elseif CurrentWeapon == -1045183535 then weapon = "CLASS 2: Revolver" elseif CurrentWeapon == 911657153 then weapon = "Taser" elseif CurrentWeapon == 324215364 then weapon = "CLASS 2: Micro-SMG" elseif CurrentWeapon == -619010992 then weapon = "CLASS 2: Machine-Pistol" elseif CurrentWeapon == 736523883 then weapon = "CLASS 2: SMG" elseif CurrentWeapon == 2024373456 then weapon = "CLASS 2: SMG MK2" elseif CurrentWeapon == -270015777 then weapon = "CLASS 2: Assault SMG" elseif CurrentWeapon == 171789620 then weapon = "CLASS 2: Combat PDW" elseif CurrentWeapon == -1660422300 then weapon = "CLASS 4: MG" elseif CurrentWeapon == -1660422300 then weapon = "CLASS 4: Combat MG" elseif CurrentWeapon == 3686625920 then weapon = "CLASS 4: Combat MG MK2" elseif CurrentWeapon == 1627465347 then weapon = "CLASS 4: Gusenberg" elseif CurrentWeapon == -1121678507 then weapon = "CLASS 2: Mini SMG" elseif CurrentWeapon == -1074790547 then weapon = "CLASS 3: Assault Rifle" elseif CurrentWeapon == 961495388 then weapon = "CLASS 3: Assault Rifle MK2" elseif CurrentWeapon == -2084633992 then weapon = "CLASS 3: Carbine Rifle" elseif CurrentWeapon == 4208062921 then weapon = "CLASS 3: Carbine Rifle MK2" elseif CurrentWeapon == -1357824103 then weapon = "CLASS 3: Advanced Rifle" elseif CurrentWeapon == -1063057011 then weapon = "CLASS 3: Special Carbine" elseif CurrentWeapon == 2132975508 then weapon = "CLASS 3: Bullpup Rifle" elseif CurrentWeapon == 1649403952 then weapon = "CLASS 3: Compact Rifle" elseif CurrentWeapon == 100416529 then weapon = "CLASS 4: Sniper Rifle" elseif CurrentWeapon == 205991906 then weapon = "CLASS 4: Heavy Sniper" elseif CurrentWeapon == 177293209 then weapon = "CLASS 4: Heavy Sniper MK2" elseif CurrentWeapon == -952879014 then weapon = "CLASS 4: Marksman Rifle" elseif CurrentWeapon == 487013001 then weapon = "CLASS 2: Pump Shotgun" elseif CurrentWeapon == 2017895192 then weapon = "CLASS 2: Sawnoff Shotgun" elseif CurrentWeapon == -1654528753 then weapon = "CLASS 3: Bullpup Shotgun" elseif CurrentWeapon == -494615257 then weapon = "CLASS 3: Assault Shotgun" elseif CurrentWeapon == -1466123874 then weapon = "CLASS 3: Musket" elseif CurrentWeapon == 984333226 then weapon = "CLASS 3: Heavy Shotgun" elseif CurrentWeapon == -275439685 then weapon = "CLASS 2: Double Barrel Shotgun" elseif CurrentWeapon == 317205821 then weapon = "CLASS 2: Auto Shotgun" elseif CurrentWeapon == -1568386805 then weapon = "CLASS 5: Grenade Launcher" elseif CurrentWeapon == -1312131151 then weapon = "CLASS 5: RPG" elseif CurrentWeapon == 125959754 then weapon = "CLASS 5: Compact Launcher" else weapon = "UNKNOWN" end
    TriggerServerEvent("dispatch:server:notify",{
...
local function VangelicoSuspicious()
    local currentPos = GetEntityCoords(PlayerPedId())
    local locationInfo = getStreetandZone(currentPos)
    local gender = GetPedGender()
    PlaySound(-1, "Lose_1st", "GTAO_FM_Events_Soundset", 0, 0, 1)
    TriggerServerEvent("dispatch:server:notify",{
        dispatchcodename = "vangelicosuspicious", -- has to match the codes in sv_dispatchcodes.lua so that it generates the right blip
        dispatchCode = "10-90",
        firstStreet = locationInfo,
        gender = gender,
        model = nil,
        ...
        dispatchMessage = "Suspicious Activity", -- message
        job = {"police"} -- jobs that will get the alerts
    })
end exports('VangelicoSuspicious', VangelicoSuspicious)

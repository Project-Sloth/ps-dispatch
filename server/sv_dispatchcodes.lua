...
dispatchCodes = {
	...
	["vangelicosuspicious"] =  {displayCode = '10-90', description = "Suspicious Activity", radius = 0, recipientList = {'police'}, blipSprite = 66, blipColour = 5, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false"},
